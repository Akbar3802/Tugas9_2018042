...
import static com.example.tugas6_alarmmanager.DBBuku.TABLENAME;
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    Intent a = new Intent(TambahData.this, Splash.class);
                    startActivity(a);
                }
                return true;
            }
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("daftarbuku", null, cv);
                if (rec != null) {
                    Toast.makeText(TambahData.this, "Data Inserted", Toast.LENGTH_SHORT).show();
...
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TambahData.this, DisplayDataBuku.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    ...
                    Intent a = new Intent(TambahData.this, DisplayDataBuku.class);
                    startActivity(a);
                }
            }
        });
